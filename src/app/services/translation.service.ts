...
export class TranslationService {
  ...
  private readonly translations: Translations = {
    en: {
      ...
      'constitution.articles.article98': 'The Prime Minister ensures the execution of laws.',
      'constitution.articles.article99': 'The Prime Minister exercises regulatory power.',
      'constitution.articles.article100': 'The Prime Minister may delegate certain of his powers to the Deputy Prime Ministers and Ministers.',
      'constitution.articles.article101': 'The acts of the Prime Minister are countersigned by the Ministers responsible for their execution.',
      'constitution.articles.article102': 'The Prime Minister assumes responsibility for the defense policy.',
      'constitution.articles.article103': 'The Prime Minister may substitute for the President of the Republic in the presidency of certain councils and committees.',
      'constitution.articles.article104': 'The Government determines and conducts the policy of the Nation.',
      'constitution.articles.article105': 'The Government is responsible to the National Assembly.',
      'constitution.articles.article106': 'The Government may engage its responsibility on its program or on a declaration of general policy.',
      'constitution.articles.article107': 'The National Assembly may call into question the responsibility of the Government by voting a motion of no confidence.',
      'constitution.articles.article108': 'The motion of no confidence is not admissible unless it is signed by at least one-tenth of the members of the National Assembly.',
      'constitution.articles.article109': 'The vote on the motion of no confidence takes place forty-eight hours after its filing.',
      'constitution.articles.article110': 'The motion of no confidence is adopted by an absolute majority of the members of the National Assembly.',
      'constitution.articles.article111': 'If the motion of no confidence is adopted, the Prime Minister must tender his resignation to the President of the Republic.',
      'constitution.articles.article112': 'The members of the Government may not be members of Parliament.',
      'constitution.articles.article113': 'The office of member of the Government is incompatible with the exercise of any professional activity.',
      'constitution.articles.article114': 'The members of the Government are criminally liable for acts accomplished in the exercise of their functions.',
      'constitution.articles.article115': 'They may be indicted by the National Assembly and tried by the Senate.',
      'constitution.articles.article116': 'An organic law determines the conditions under which the Government exercises its functions.',
      ...
      'constitution.articles.article126': 'The Senate is composed of senators elected by the provincial assemblies.',
      'constitution.articles.article127': 'The senators are elected for a term of five years renewable.',
      'constitution.articles.article128': 'The Senate elects its President and other members of its Bureau.',
      'constitution.articles.article129': 'The Senate establishes its internal regulations.',
      'constitution.articles.article130': 'The Government presents its program to the National Assembly.',
      'constitution.articles.article131': 'The Government may ask the National Assembly for a vote of confidence.',
      'constitution.articles.article132': 'The Government may make the adoption of a draft law a question of confidence.',
      'constitution.articles.article133': 'The National Assembly may vote a motion of censure against the Government.',
      'constitution.articles.article134': 'The motion of censure must be signed by at least one-tenth of the members of the National Assembly.',
      ...
      'constitution.articles.article136': 'The budget law is voted by Parliament before the beginning of the fiscal year.',
      'constitution.articles.article137': 'If the budget law has not been voted before the beginning of the fiscal year, the Government may collect taxes and make expenditures on the basis of the previous budget.',
      'constitution.articles.article138': 'The Court of Accounts assists Parliament in monitoring the execution of the budget.',
      'constitution.articles.article139': 'Parliamentary sessions are public unless otherwise decided by the respective chambers.',
      ...
      'constitution.articles.article141': 'The commissions of inquiry have the same powers of investigation as the judicial authorities.',
      'constitution.articles.article142': 'The commissions of inquiry may not interfere with judicial proceedings.',
      'constitution.articles.article143': 'Parliament may delegate to the Government the power to take measures normally within the legislative domain.',
      'constitution.articles.article144': 'Such delegation is granted for a limited time and for a specific purpose.',
      'constitution.articles.article145': 'The members of Parliament may address written questions to the Government.',
      'constitution.articles.article146': 'The Government must respond to written questions within thirty days.',
      'constitution.articles.article147': 'Members of Parliament may address oral questions to the Government during question time.',
      'constitution.articles.article148': 'The Government may be heard by parliamentary committees.',
      'constitution.articles.article149': 'Parliament controls the action of the Government.',
      ...
      'constitution.articles.article161': 'The Governor represents the province in its relations with the central government.',
      'constitution.articles.article162': 'The Governor ensures the execution of national laws and provincial edicts.',
      'constitution.articles.article163': 'The Governor may be dismissed by the Provincial Assembly by a motion of no confidence.',
      'constitution.articles.article164': 'The Provincial Assembly may legislate in matters of provincial competence.',
      ...
      'constitution.articles.article166': 'The territorial entities have administrative and financial autonomy.',
      'constitution.articles.article167': 'The territorial entities manage their own affairs under the supervision of the central authority.',
      'constitution.articles.article168': 'The mayors of cities are elected by the city councils.',
      'constitution.articles.article169': 'The burgomaster of communes are elected by the communal councils.',
      'constitution.articles.article170': 'The decentralized territorial entities have financial autonomy.',
      'constitution.articles.article171': 'The territorial entities may contract loans subject to authorization by the central government.',
      'constitution.articles.article172': 'The territorial entities prepare and execute their own budgets.',
      'constitution.articles.article173': 'The central government may substitute for territorial entities in case of serious deficiency.',
      'constitution.articles.article174': 'Conflicts between territorial entities are resolved by the administrative courts.',
      'constitution.articles.article175': 'The creation of provinces is decided by law.',
      'constitution.articles.article176': 'The creation of new provinces requires the consent of the population concerned.',
      'constitution.articles.article177': 'The modification of provincial boundaries requires an organic law.',
      'constitution.articles.article178': 'The city of Kinshasa has the status of a province.',
      'constitution.articles.article179': 'Kinshasa is administered by a Governor and a City Council.',
    ...
    fr: {
      ...
      'constitution.articles.article51': 'Tout Congolais a le droit de vote et d\'éligibilité.',
      'constitution.articles.article52': 'Toute personne a le droit de participer à la conduite des affaires publiques.',
      'constitution.articles.article53': 'Toute personne a le droit d\'accéder dans des conditions d\'égalité aux fonctions publiques.',
      'constitution.articles.article54': 'Tout citoyen a le droit de prendre part aux manifestations pacifiques.',
      'constitution.articles.article55': 'Tout citoyen a le droit de pétition auprès des pouvoirs publics.',
      'constitution.articles.article56': 'Toute personne a droit à la formation professionnelle et au recyclage.',
      'constitution.articles.article57': 'Toute personne a droit à la sécurité sociale.',
      'constitution.articles.article58': 'Les travailleurs ont le droit de grève.',
      'constitution.articles.article59': 'Toute personne a le droit d\'adhésion syndicale.',
      ...
      'constitution.articles.article98': 'Le Premier ministre assure l\'exécution des lois.',
      'constitution.articles.article99': 'Le Premier ministre exerce le pouvoir réglementaire.',
      'constitution.articles.article100': 'Le Premier ministre peut déléguer certains de ses pouvoirs aux Vice-premiers ministres et aux Ministres.',
      'constitution.articles.article101': 'Les actes du Premier ministre sont contresignés par les Ministres chargés de leur exécution.',
      'constitution.articles.article102': 'Le Premier ministre assume la responsabilité de la politique de défense.',
      'constitution.articles.article103': 'Le Premier ministre peut suppléer le Président de la République dans la présidence de certains conseils et comités.',
      'constitution.articles.article104': 'Le Gouvernement détermine et conduit la politique de la Nation.',
      'constitution.articles.article105': 'Le Gouvernement est responsable devant l\'Assemblée nationale.',
      'constitution.articles.article106': 'Le Gouvernement peut engager sa responsabilité sur son programme ou sur une déclaration de politique générale.',
      'constitution.articles.article107': 'L\'Assemblée nationale peut mettre en cause la responsabilité du Gouvernement par le vote d\'une motion de censure.',
      'constitution.articles.article108': 'La motion de censure n\'est recevable que si elle est signée par un dixième au moins des membres de l\'Assemblée nationale.',
      'constitution.articles.article109': 'Le vote sur la motion de censure a lieu quarante-huit heures après son dépôt.',
      'constitution.articles.article110': 'La motion de censure est adoptée à la majorité absolue des membres de l\'Assemblée nationale.',
      'constitution.articles.article111': 'Si la motion de censure est adoptée, le Premier ministre doit remettre sa démission au Président de la République.',
      'constitution.articles.article112': 'Les membres du Gouvernement ne peuvent être membres du Parlement.',
      'constitution.articles.article113': 'La fonction de membre du Gouvernement est incompatible avec l\'exercice de toute activité professionnelle.',
      'constitution.articles.article114': 'Les membres du Gouvernement sont pénalement responsables des actes accomplis dans l\'exercice de leurs fonctions.',
      'constitution.articles.article115': 'Ils peuvent être mis en accusation par l\'Assemblée nationale et jugés par le Sénat.',
      'constitution.articles.article116': 'Une loi organique détermine les conditions dans lesquelles le Gouvernement exerce ses fonctions.',
      ...
      'constitution.articles.article126': 'Le Sénat est composé de sénateurs élus par les assemblées provinciales.',
      'constitution.articles.article127': 'Les sénateurs sont élus pour un mandat de cinq ans renouvelable.',
      'constitution.articles.article128': 'Le Sénat élit son Président et les autres membres de son Bureau.',
      'constitution.articles.article129': 'Le Sénat établit son règlement intérieur.',
    ...
    ln: {
      ...
      // Constitution articles - Economic and Social Rights (41-50)
      'constitution.articles.article41': 'Moto nyonso azali na ndingisa ya mai.',
      'constitution.articles.article42': 'Moto nyonso azali na ndingisa ya koyekola.',
      'constitution.articles.article43': 'Koyekola ya liboso ezali ya ntina pe ya ofele na ba ndako ya leta.',
      'constitution.articles.article44': 'Moto nyonso azali na ndingisa ya kosepela na mayemi pe ya kosangana na bomoi ya mimeseno ya lisanga.',
      'constitution.articles.article45': 'Moto nyonso azali na ndingisa ya zando ya malamu oyo ekokola bokoli na ye.',
      'constitution.articles.article46': 'Moto nyonso azali na ndingisa ya biloko na ye.',
      'constitution.articles.article47': 'Moto moko te akoki kobotolama biloko na ye longola kaka mpo na bolamu ya bato pe na kokabana mbongo ya sembo liboso.',
      'constitution.articles.article48': 'Ndingisa ya kozwa libula ya bato bakufi ezali na ndimbola.',
      'constitution.articles.article49': 'Mukongo nyonso azali na ndingisa ya kotambola pe ya kovanda na bisika oyo alingi na mokili ya ekolo.',
      'constitution.articles.article50': 'Mukongo nyonso azali na ndingisa pe mokumba ya kobatela mboka.',
      ...
      // Citizen Duties and State Organization (Articles 60-68)
      'constitution.articles.article60': 'Moto nyonso ya Congo azali na mokumba ya kotanga eta pe ya kosala misala oyo eta epesi.',
      'constitution.articles.article61': 'Moto nyonso azali na mokumba ya komema lidusu na eta pe ya kofuta ba mpako.',
      'constitution.articles.article62': 'Moto nyonso azali na mokumba ya kobatela liloba ya eta pe ya kozwa monganga ya eta.',
      'constitution.articles.article63': 'Moto nyonso azali na mokumba ya kobatela zando ya liboso pe ya bato ya mboka.',
      'constitution.articles.article64': 'Moto nyonso azali na mokumba ya kosala mpo na boyokani pe na bomoi malamu ya bato nyonso.',
      'constitution.articles.article65': 'Bana bazali na mokumba ya kosalela malamu ntango ya kelasi pe ya kondima ba malako ya bato bazali',
      'constitution.articles.article66': 'Baboti bazali na mokumba ya kolendisa bana na bango pe ya kopesa bango malako.',
      'constitution.articles.article67': 'Mikolo ya bonsomi pe ya ba fête ya eta ekozala korespectuer.',
      'constitution.articles.article68': 'Falanse ezali monoko ya ofisiele ya République Démocratique ya Congo.',
      ...
      // Constitution articles - Executive Power continued (86-97)
      'constitution.articles.article86': 'Mokambi ya République azali kosala boyokani pe kopanza ba traité.',
      'constitution.articles.article87': 'Mokambi ya République akoki kopanza Assemblée nationale.',
      'constitution.articles.article88': 'Mokambi ya République azali kotindela bato ya ekolo makambo.',
      'constitution.articles.article89': 'Mokambi ya République akoki kosenga Parlement etalela libumu mobeko.',
      'constitution.articles.article90': 'Mokambi ya République akoki, nsima ya kotuna Premier ministre pe ba Mokambi ya ba Chambre mibale ya Parlement, kokitisa likambo na referendum.',
      'constitution.articles.article91': 'Tango ba institution ya République, bonsomi ya ekolo to bosembo ya mokili ezali na likama, Mokambi ya République akoki kosakola état d\'urgence to état de siège.',
      'constitution.articles.article92': 'Mokambi ya République abandaka misala na ye nsima ya kolapa ndayi liboso ya Cour constitutionnelle.',
      'constitution.articles.article93': 'Mokambi ya République azali na bobateli ya bakojokama te na ntango ya mosala na ye.',
      'constitution.articles.article94': 'Mokambi ya République akoki kofungama kaka mpo na boteke ya likolo liboso ya Sénat.',
      'constitution.articles.article95': 'Soki Mokambi ya République azali lisusu te, Mokambi ya Sénat asalaka bisalo ya Mokambi.',
      'constitution.articles.article96': 'Gouvernement esangisami na Premier ministre, ba Vice-premiers ministres, ba Ministre pe ba Vice-ministres.',
      'constitution.articles.article97': 'Premier ministre azali motó ya gouvernement. Azali kokamba mosala ya Gouvernement.',

      // Constitution articles - Government Functions (98-116)
      'constitution.articles.article98': 'Premier ministre azali kosala ete ba loi esalema.',
      'constitution.articles.article99': 'Premier ministre azali na makoki ya kosala ba mibeko ya règlement.',
      'constitution.articles.article100': 'Premier ministre akoki kopesa ba Vice-premiers ministres pe ba Ministre ndambo ya makoki na ye.',
      'constitution.articles.article101': 'Ba makambo ya Premier ministre esengeli kotiyama nsango ya ba Ministre oyo basengeli kosala yango.',
      'constitution.articles.article102': 'Premier ministre azali na mokumba ya ba makambo ya bobateli.',
      'constitution.articles.article103': 'Premier ministre akoki kozala na esika ya Mokambi ya République na kokamba ba conseil pe ba comité mosusu.',
      'constitution.articles.article104': 'Gouvernement ezali komona pe kokamba ba makambo ya Ekolo.',
      'constitution.articles.article105': 'Gouvernement esengeli kopesa ntango ya misala na yango na Assemblée nationale.',
      'constitution.articles.article106': 'Gouvernement ekoki komitisa mokumba na yango na programme na yango to na maloba ya politique générale.',
      'constitution.articles.article107': 'Assemblée nationale ekoki kotuna mokumba ya Gouvernement na kopona motion ya bokutani.',
      'constitution.articles.article108': 'Motion ya bokutani endimami te soki etiami nsango ya ba membre ya zomi te ya Assemblée nationale.',
      'constitution.articles.article109': 'Vote na motion ya bokutani esalemi nsima ya mikolo 48 ya kobwaka yango.',
      'constitution.articles.article110': 'Motion ya bokutani endimami na motango ya mingi ya ba membre ya Assemblée nationale.',
      'constitution.articles.article111': 'Soki motion ya bokutani endimami, Premier ministre asengeli kopesa mokili na ye na Mokambi ya République.',
      'constitution.articles.article112': 'Ba membre ya Gouvernement bakoki kozala ba membre ya Parlement te.',
      'constitution.articles.article113': 'Mosala ya membre ya Gouvernement ekoki kosangana te na mosala ya mosusu.',
      'constitution.articles.article114': 'Ba membre ya Gouvernement bazali na mokumba ya ba makambo ya mabe oyo basali na mosala na bango.',
      'constitution.articles.article115': 'Bakoki kofingama na Assemblée nationale mpe kosambasama na Sénat.',
      'constitution.articles.article116': 'Mobeko ya organique emonisi ndenge oyo Gouvernement esalaka misala na yango.',
    ...
    sw: {
      ...
      // Constitution articles - Economic and Social Rights (41-50)
      'constitution.articles.article41': 'Kila mtu ana haki ya maji.',
      'constitution.articles.article42': 'Kila mtu ana haki ya elimu.',
      'constitution.articles.article43': 'Elimu ya msingi ni ya lazima na ya bure katika taasisi za umma.',
      'constitution.articles.article44': 'Kila mtu ana haki ya kufurahia sanaa na kushiriki kwa uhuru katika maisha ya kitamaduni ya jamii.',
      'constitution.articles.article45': 'Kila mtu ana haki ya mazingira mazuri yanayofaa kwa maendeleo yake.',
      'constitution.articles.article46': 'Kila mtu ana haki ya mali.',
      'constitution.articles.article47': 'Hakuna mtu anayeweza kunyimwa mali yake isipokuwa kwa manufaa ya umma na kwa fidia ya haki na ya awali.',
      'constitution.articles.article48': 'Haki ya urithi imedhaminiwa.',
      'constitution.articles.article49': 'Kila Mkongo ana haki ya kusonga na kukaa kwa uhuru katika eneo la kitaifa.',
      'constitution.articles.article50': 'Kila Mkongo ana haki na wajibu wa kulinda nchi.',
      ...
      // Citizen Duties and State Organization (Articles 60-68)
      'constitution.articles.article60': 'Kila Mkongo ana wajibu wa kuheshimu serikali na kufuata amri za serikali.',
      'constitution.articles.article61': 'Kila mtu ana wajibu wa kushiriki katika uzito wa serikali na kulipa kodi.',
      'constitution.articles.article62': 'Kila mtu ana wajibu wa kuheshimu amri za serikali na kupokea huduma za serikali.',
      'constitution.articles.article63': 'Kila mtu ana wajibu wa kulinda mazingira ya kwanza na watu wa taifa.',
      'constitution.articles.article64': 'Kila mtu ana wajibu wa kufanya kazi kwa amani na maisha mazuri ya watu wote.',
      'constitution.articles.article65': 'Watoto wana wajibu wa kutumia vizuri wakati wa shule na kukubali maagizo ya watu wazima.',
      'constitution.articles.article66': 'Wazazi wana wajibu wa kulea watoto wao na kuwapa maelekezo.',
      'constitution.articles.article67': 'Siku za mapumziko na sikukuu za serikali zitaheshimiwa.',
      'constitution.articles.article68': 'Kifaransa ni lugha rasmi ya Jamhuri ya Kidemokrasia ya Kongo.',
      ...
      // Constitution articles - Executive Power continued (86-97)
      'constitution.articles.article86': 'Rais wa Jamhuri anashughulikia mazungumzo na kuthibitisha mikataba.',
      'constitution.articles.article87': 'Rais wa Jamhuri anaweza kuvunja Bunge la Kitaifa.',
      'constitution.articles.article88': 'Rais wa Jamhuri anatuma ujumbe kwa taifa.',
      'constitution.articles.article89': 'Rais wa Jamhuri anaweza kuomba Bunge lichukulie upya sheria.',
      'constitution.articles.article90': 'Rais wa Jamhuri anaweza, baada ya kushauriana na Waziri Mkuu na Wakuu wa Vyumba viwili vya Bunge, kuamua kuwasilisha mswada wowote kwa kura ya maoni.',
      'constitution.articles.article91': 'Wakati taasisi za Jamhuri, uhuru wa taifa au uongozi wa eneo la kitaifa zinapokabiliwa na hatari, Rais wa Jamhuri anaweza kutangaza hali ya dharura au hali ya kijeshi.',
      'constitution.articles.article92': 'Rais wa Jamhuri anaanza majukumu yake baada ya kuapa mbele ya Mahakama ya Kikatiba.',
      'constitution.articles.article93': 'Rais wa Jamhuri ana kinga ya kushitakiwa wakati wa muhula wake wa mamlaka.',
      'constitution.articles.article94': 'Rais wa Jamhuri anaweza kushitakiwa tu kwa uhaini mkuu mbele ya Seneti.',
      'constitution.articles.article95': 'Ikiwa nafasi ya Urais itakuwa wazi, Rais wa Seneti anafanya kazi za muda.',
      'constitution.articles.article96': 'Serikali inajumuisha Waziri Mkuu, Makamu wa Waziri Mkuu, Mawaziri na Makamu wa Mawaziri.',
      'constitution.articles.article97': 'Waziri Mkuu ni mkuu wa serikali. Anaongoza vitendo vya Serikali.',

      // Constitution articles - Government Functions (98-116)
      'constitution.articles.article98': 'Waziri Mkuu anahakikisha utekelezaji wa sheria.',
      'constitution.articles.article99': 'Waziri Mkuu ana mamlaka ya kanuni.',
      'constitution.articles.article100': 'Waziri Mkuu anaweza kukabidhia baadhi ya mamlaka yake kwa Makamu wa Waziri Mkuu na Mawaziri.',
      'constitution.articles.article101': 'Vitendo vya Waziri Mkuu vinapaswa kusainiwa na Mawaziri wanaowajibika kwa utekelezaji wake.',
      'constitution.articles.article102': 'Waziri Mkuu ana jukumu la sera ya ulinzi.',
      'constitution.articles.article103': 'Waziri Mkuu anaweza kuwa mbadala wa Rais wa Jamhuri katika uongozaji wa baadhi ya majimbo na kamati.',
      'constitution.articles.article104': 'Serikali inaamua na kuongoza sera za Taifa.',
      'constitution.articles.article105': 'Serikali inawajibika kwa Bunge la Kitaifa.',
      'constitution.articles.article106': 'Serikali inaweza kujitolea uwajibikaji wake kwa programu yake au kwa tamko la sera ya jumla.',
      'constitution.articles.article107': 'Bunge la Kitaifa linaweza kuuliza uwajibikaji wa Serikali kwa kupiga kura ya kutokuwa na imani.',
      'constitution.articles.article108': 'Hoja ya kutokuwa na imani haikubali isipokuwa imesainiwa na angalau moja ya kumi ya wanachama wa Bunge la Kitaifa.',
      'constitution.articles.article109': 'Kura ya hoja ya kutokuwa na imani inafanyika saa arobaini na nane baada ya kuwasilishwa kwake.',
      'constitution.articles.article110': 'Hoja ya kutokuwa na imani inapitishwa kwa wengi wa wanachama wa Bunge la Kitaifa.',
      'constitution.articles.article111': 'Ikiwa hoja ya kutokuwa na imani imepitishwa, Waziri Mkuu lazima apeane uongozi wake kwa Rais wa Jamhuri.',
      'constitution.articles.article112': 'Wanachama wa Serikali hawawezi kuwa wanachama wa Bunge.',
      'constitution.articles.article113': 'Kazi ya mwanachama wa Serikali haipatani na zoezi la shughuli yoyote ya kitaaluma.',
      'constitution.articles.article114': 'Wanachama wa Serikali wana jukumu la kisheria la vitendo vilivyofanywa katika kufanya kazi kwao.',
      'constitution.articles.article115': 'Wanaweza kushtakiwa na Bunge la Kitaifa na kuhukumiwa na Seneti.',
      'constitution.articles.article116': 'Sheria ya kimsingi inabainisha masharti ambayo Serikali inatekeleza majukumu yake.',
    ...
    lu: {
      ...
      // Constitution articles - Economic and Social Rights (41-50)
      'constitution.articles.article41': 'Muntu weetu une dilengiso dia mai.',
      'constitution.articles.article42': 'Muntu weetu une dilengiso dia malongi.',
      'constitution.articles.article43': 'Malongi ma bwantu ma kutangisha mafuala ne ma mpepo mu makampu ma leta.',
      'constitution.articles.article44': 'Muntu weetu une dilengiso dia kusepela ni buyemi ne kuya mu bukalenge bua kimbanda kia busantu.',
      'constitution.articles.article45': 'Muntu weetu une dilengiso dia ukondo ua malamu uukilangane ne mukulu waawu.',
      'constitution.articles.article46': 'Muntu weetu une dilengiso dia bindu byaawu.',
      'constitution.articles.article47': 'Muntu yakayaka ukumona kubotolwa bindu byaawu katshi mu bulamu bua bantu ne kuabika mbongo ya busembo buya kwanza.',
      'constitution.articles.article48': 'Dilengiso dia kuwana bulua bua batu bafuile dine dibapila.',
      'constitution.articles.article49': 'Mukongo weetu une dilengiso dia kwendelesha ne kuyenda mu bisalako bonso mu ntoto ua kanda.',
      'constitution.articles.article50': 'Mukongo weetu une dilengiso ne muya ua kulinda mboka.',
      ...
      // Citizen Duties and State Organization (Articles 60-68)
      'constitution.articles.article60': 'Mukongo weetu une muya ua kuyaya leta ne kulandisha misalu yamuye leta.',
      'constitution.articles.article61': 'Muntu weetu une muya ua kusanga buito bua leta ne kufuta ba mpako.',
      'constitution.articles.article62': 'Muntu weetu une muya ua kuyaya malako ma leta ne kutambula malongi ma leta.',
      'constitution.articles.article63': 'Muntu weetu une muya ua kulinda buzaba bua kwanza ne batu ba kanda.',
      'constitution.articles.article64': 'Muntu weetu une muya ua kusala mu ndjala ne buumi butambulufu bua batu boonso.',
      'constitution.articles.article65': 'Bana bane muya ua kusala bulamu katumpu ka malongi ne kuwana malako ma batu bazibikilu.',
      'constitution.articles.article66': 'Ba dikolodi bane muya ua kulela bana baabo ne kumupa malako.',
      'constitution.articles.article67': 'Bilumbu bya kupumula ne bya bifueshi bya leta bikuyayilwa.',
      'constitution.articles.article68': 'Kifalanse ni lukumu lua bufisi lua Republiki ya Ntanda ya Kongo.',
      ...
      // Constitution articles - Executive Power continued (86-97)
      'constitution.articles.article86': 'Mukalenga ua Republiki usala makutu ne kuthibitisha ba traité.',
      'constitution.articles.article87': 'Mukalenga ua Republiki ukumona kupanzisha Assemblée nationale.',
      'constitution.articles.article88': 'Mukalenga ua Republiki utumina makambo ku batu ba kanda.',
      'constitution.articles.article89': 'Mukalenga ua Republiki ukumona kusenga Parlement utalele kua tubidi mubengele.',
      'constitution.articles.article90': 'Mukalenga ua Republiki ukumona, bukasha atune Premier ministre ne ba Mukalenga ba ba Chambre bibidi bya Parlement, kusolola kutungisha likambo ku referendum.',
      'constitution.articles.article91': 'Tshiamu ba institution za Republiki, bwanga bua kanda kata busembo bua tshitetu buuika kuli kunda, Mukalenga ua Republiki ukumona kusakolela état d\'urgence kata état de siège.',
      'constitution.articles.article92': 'Mukalenga ua Republiki ubandya misalu yaye bukasha alaye ndai panji pa Cour constitutionnelle.',
      'constitution.articles.article93': 'Mukalenga ua Republiki une kubalwa kua kulandwa mu ntangu ya musalu waye.',
      'constitution.articles.article94': 'Mukalenga ua Republiki ukumona kulandwa kaka mpo boteki bua kunene panji pa Senat.',
      'constitution.articles.article95': 'Bukasha Mukalenga ua Republiki kanshile, Mukalenga ua Senat usala bisalu bya Mukalenga.',
      'constitution.articles.article96': 'Gouvernement usangisami na Premier ministre, ba Vice-premiers ministres, ba Ministre ne ba Vice-ministres.',
      'constitution.articles.article97': 'Premier ministre undi mutue ua gouvernement. Ulongola musalu ua Gouvernement.',

      // Constitution articles - Government Functions (98-116)
      'constitution.articles.article98': 'Premier ministre usala apa ba loi isalelu.',
      'constitution.articles.article99': 'Premier ministre une bukumu bua kusala ba mubengele ya règlement.',
      'constitution.articles.article100': 'Premier ministre ukumona kupanza ba Vice-premiers ministres ne ba Ministre ndambo ya bukumu buaye.',
      'constitution.articles.article101': 'Ba makambo ma Premier ministre mafuala kutiyilwa mu nsaku ya ba Ministre bauana kusala.',
      'constitution.articles.article102': 'Premier ministre une mukumba ua ba makambo ma kubalwa.',
      'constitution.articles.article103': 'Premier ministre ukumona kuba busaku bua Mukalenga ua Republiki mu kulongola ba conseil ne ba comité bansambi.',
      'constitution.articles.article104': 'Gouvernement umona ne ulongola ba makambo ma Kanda.',
      'constitution.articles.article105': 'Gouvernement ufuala kupanza ntangu ya misalu yaye ku Assemblée nationale.',
      'constitution.articles.article106': 'Gouvernement ukumona kumikisha mukumba waye ku programme yaye kata ku maloba ma politique générale.',
      'constitution.articles.article107': 'Assemblée nationale ikumona kutuna mukumba ua Gouvernement ku kupiga vote ya motion ya butekani.',
      'constitution.articles.article108': 'Motion ya butekani iyangulwu te bukasha ibikishiwa mu nsaku ya ba membre ya kumi te ya Assemblée nationale.',
      'constitution.articles.article109': 'Vote ya motion ya butekani isalama bukasha ma siku 48 ya kubitila yayo.',
      'constitution.articles.article110': 'Motion ya butekani iyangulwa ku mitungu miyingi ya ba membre ya Assemblée nationale.',
      'constitution.articles.article111': 'Bukasha motion ya butekani iyangulwa, Premier ministre ufuala kupanza busaku bua kanda buaye ku Mukalenga ua Republiki.',
      'constitution.articles.article112': 'Ba membre ya Gouvernement bakumona kuba ba membre ya Parlement te.',
      'constitution.articles.article113': 'Musalu ua membre ya Gouvernement ukumona kusangana te ne musalu wanzambi.',
      'constitution.articles.article114': 'Ba membre ya Gouvernement bane mukumba ua ba makambo mabi masalilue mu musalu wabo.',
      'constitution.articles.article115': 'Bakumona kulondolwa na Assemblée nationale ne kulandwa na Senat.',
      'constitution.articles.article116': 'Mubengele ua organique umonisha ndenge Gouvernement usalaka misalu yaye.',
    ...
    kg: {
      ...
      // Economic and Social Rights (Articles 41-50)
      'constitution.articles.article41': 'Ndingisa ye ndoki ya maza ma banlongo mazayila mu mioko mia besi ba leta.',
      'constitution.articles.article42': 'Bwana bua malongi buzayila mubika leta. Leta izayila butika malongi ma bana.',
      'constitution.articles.article43': 'Leta izayila butika mayela ma bwanga ye musalu ku bamuntu bonso.',
      'constitution.articles.article44': 'Besi ba leta bazayila wila kulonga mbote ya biloko.',
      'constitution.articles.article45': 'Leta izayila butika nzo ye buabamangi bua bamuntu bonso.',
      'constitution.articles.article46': 'Mbote ya muntu ye ya bamuntu wonso izayila mu mioko mia leta.',
      'constitution.articles.article47': 'Muntu uzayila ndingisa ya biloko biaye bonso.',
      'constitution.articles.article48': 'Leta izayila wila buka ndonga mbote mu mayela ma biziku ye ba mayela.',
      'constitution.articles.article49': 'Ndonga ya kupumuka ye ya kusepela izayila mu mioko mia leta.',
      'constitution.articles.article50': 'Leta izayila butika mayela ma makanda ye makutu ku bana bonso.',
      ...
      // Citizen Duties and State Organization (Articles 60-68)
      'constitution.articles.article60': 'Mukongo woso uzayila muya wa kuyaya leta ye kulandisa misalu imuaye leta.',
      'constitution.articles.article61': 'Muntu woso uzayila muya wa kusanga buito bua leta ye kutunga ba mpako.',
      'constitution.articles.article62': 'Muntu woso uzayila muya wa kuyaya malako ma leta ye kutambula malongi ma leta.',
      'constitution.articles.article63': 'Muntu woso uzayila muya wa kulinda buzaba bua kwanza ye batu ba kanda.',
      'constitution.articles.article64': 'Muntu woso uzayila muya wa kusala mu ndjala ye buumi bua lulendo bua batu wonso.',
      'constitution.articles.article65': 'Bana bazayila muya wa kusala malamu katumbu ka malongi ye kuwana malako ma batu banene.',
      'constitution.articles.article66': 'Ba dikolodi bazayila muya wa kulela bana baawu ye kumupa malako.',
      'constitution.articles.article67': 'Bilumbu bya kupumuka ye bya mifueshi ya leta bikuyayilwa.',
      'constitution.articles.article68': 'Kifalanse ni lukumu lua ndimi ya leta ya République Démocratique ya Kongo.',
      ...
      // Constitution articles - Executive Power continued (86-97)
      'constitution.articles.article86': 'Mfumu ya Republiki isala makutu ye kuthibitisha ba traité.',
      'constitution.articles.article87': 'Mfumu ya Republiki ikumona kupanzika Assemblée nationale.',
      'constitution.articles.article88': 'Mfumu ya Republiki itumina makambu kuna batu ba kanda.',
      'constitution.articles.article89': 'Mfumu ya Republiki ikumona kusenga Parlement utalele kavutu mambimbi.',
      'constitution.articles.article90': 'Mfumu ya Republiki ikumona, bukasha itune Premier ministre ye ba Mfumu ba ba Chambre zole za Parlement, kusolola kutuga likambu ku referendum.',
      'constitution.articles.article91': 'Ntangu ba institution za Republiki, buwanga bua kanda kata busembo bua ntoto buukila kanda, Mfumu ya Republiki ikumona kusakola état d\'urgence kata état de siège.',
      'constitution.articles.article92': 'Mfumu ya Republiki ibanda misalu yaye bukasha ilaye ndai va ntualolo wa Cour constitutionnelle.',
      'constitution.articles.article93': 'Mfumu ya Republiki izayila kubalwa kua kulandwa mu ntangu ya musalu waye.',
      'constitution.articles.article94': 'Mfumu ya Republiki ikumona kulandwa kaka mpo ya boteki bua kunene va ntualolo wa Seneti.',
      'constitution.articles.article95': 'Bukasha Mfumu ya Republiki kayisi, Mfumu ya Seneti isala bisalu bya Mfumu.',
      'constitution.articles.article96': 'Gouvernement isangisama na Premier ministre, ba Vice-premiers ministres, ba Ministre ye ba Vice-ministres.',
      'constitution.articles.article97': 'Premier ministre indi ntu ya gouvernement. Ilongola musalu wa Gouvernement.',

      // Constitution articles - Government Functions (98-116)
      'constitution.articles.article98': 'Premier ministre isala apa ba loi isalemu.',
      'constitution.articles.article99': 'Premier ministre ina lulendo lua kusala ba mambimbi ma règlement.',
      'constitution.articles.article100': 'Premier ministre ikumona kupanza ba Vice-premiers ministres ye ba Ministre ndambo ya lulendo luaye.',
      'constitution.articles.article101': 'Ba makambu ma Premier ministre mafweti kutiyilwa mu nsangu ya ba Ministre bauana kusala.',
      'constitution.articles.article102': 'Premier ministre ina mukumba wa ba makambu ma kubalwa.',
      'constitution.articles.article103': 'Premier ministre ikumona kuba busaku bua Mfumu ya Republiki mu kulongola ba conseil ye ba comité banzambi.',
      'constitution.articles.article104': 'Gouvernement imona ye ilongola ba makambu ma Kanda.',
      'constitution.articles.article105': 'Gouvernement ifweti kupanza ntangu ya misalu yaye kwa Assemblée nationale.',
      'constitution.articles.article106': 'Gouvernement ikumona kumikisa mukumba waye ku programme yaye kata ku maloba ma politique générale.',
      'constitution.articles.article107': 'Assemblée nationale ikumona kutuna mukumba wa Gouvernement ku kupiga vote ya motion ya butekani.',
      'constitution.articles.article108': 'Motion ya butekani iyangulwa te bukasha ibikiswa mu nsangu ya ba mwana ya kumi te ya Assemblée nationale.',
      'constitution.articles.article109': 'Vote ya motion ya butekani isalama bukasha ma yilu 48 ya kubitila yayo.',
      'constitution.articles.article110': 'Motion ya butekani iyangulwa ku mitungu miyingi ya ba mwana ya Assemblée nationale.',
      'constitution.articles.article111': 'Bukasha motion ya butekani iyangulwa, Premier ministre ifweti kupanza busaku bua kanda buaye kwa Mfumu ya Republiki.',
      'constitution.articles.article112': 'Ba mwana ya Gouvernement bakumona kuba ba mwana ya Parlement te.',
      'constitution.articles.article113': 'Musalu wa mwana ya Gouvernement ukumona kusangana te ne musalu wanzambi.',
      'constitution.articles.article114': 'Ba mwana ya Gouvernement bazayila mukumba wa ba makambu mabi masalilwe mu musalu wabo.',
      'constitution.articles.article115': 'Bakumona kulongolwa na Assemblée nationale ye kulandwa na Seneti.',
      'constitution.articles.article116': 'Mambimbi ma organique mamonisa ndenge Gouvernement isalaka misalu yaye.',
